...
# classe para representar grafos de sobreposições
# Esta classe – OverlapGraph - é uma sub-classe da classe 
# MyGraph para representar grafos orientados
...
#        self.reps = reps
    ...
    # funçao para dar a sequencia reconstruida dado um caminho no grafo 
    def seq_from_path(self, path):
        if not self.check_if_hamiltonian_path(path): # verifica se é um caminho hamiltoniano
            return None
