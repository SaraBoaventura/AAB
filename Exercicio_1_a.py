# -*- coding: utf-8 -*-
"""
Created on Mon Mar 29 15:01:14 2021
...
class SuffixTree:
    ...
    def nodes_below (self, node): # nos que estao abaixo de um determinado nó 
        res = []
        if self.nodes[node][0] < 0: # é um nó
            ...
            return res[1::]   # como o primeiro elemento da lista (elemento 0) é o proprio nó apresenta-se apenas os seguintes valores      
